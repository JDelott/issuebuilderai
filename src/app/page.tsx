...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#111111] overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-900 hover:bg-zinc-800 text-white text-[10px] lg:text-sm rounded-sm transition-colors"
            >
              <svg className="w-3.5 h-3.5 lg:w-5 lg:h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Main Content */}
      <main className="flex-1 w-full flex items-center py-20 lg:py-32">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Left Column */}
            <div className="flex flex-col justify-center">
              <h2 className="text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] mb-12 text-white">
                ISSUE<br />
              ...
              <div className="space-y-4">
                <button 
                  ...
                  className="group inline-flex items-center gap-3 bg-zinc-900 hover:bg-zinc-800 px-8 py-4 text-white text-base rounded-sm transition-all"
                >
                ...
                <p className="text-sm text-neutral-500">Authentication required to create and manage issues</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute left-[26px] top-0 h-full w-[2px] bg-zinc-800"/>
                ...
                <div className="space-y-24">
                  {[
                    ...
                    <div key={num} className="relative group">
                      <div className="absolute left-0 top-0 h-14 w-14 rounded-sm bg-zinc-900 group-hover:bg-[#FF3F0A]/10 transition-colors">
                        <div className="absolute inset-[2px] bg-[#111111] flex items-center justify-center text-[#FF3F0A] font-mono text-xl">
                          {num}
                        </div>
                      </div>
                      
                      <div className="pl-20">
                        <h3 className="text-white font-medium text-2xl lg:text-3xl mb-4">{title}</h3>
      ...
      <footer className="w-full border-t border-neutral-800">
        <div className="container mx-auto px-6 lg:px-12 py-6">
          <div className="text-neutral-500 text-sm text-center">© 2024 IssueBuilder AI</div>
        </div>
      </footer>
    </div>
  );
