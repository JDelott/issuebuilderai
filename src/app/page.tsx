      ...
      <header className="w-full">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6">
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center gap-2 px-3.5 py-2 sm:px-4 sm:py-2 bg-zinc-900 hover:bg-zinc-800 text-white text-xs sm:text-sm rounded transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-6">
              ...
              <div className="space-y-4">
                <button className="group flex items-center justify-center gap-3 w-full sm:w-auto bg-zinc-900 hover:bg-zinc-800 px-8 py-4 text-white text-base rounded-sm transition-all">
